...
describe("BrowserOfficeSessionService", () => {
  it("saves and restores restorable office session state", () => {
    ...
    source.externalProjectDevelopmentRequestDrafts["external-crm"] = {
      ...
      requirementsArtifactPath: ".agent-workflow/external-requests/external-crm/20260825T00000000-requirements.md",
    ...
    source.externalProjectAdosRunPreparations["external-crm"] = {
      ...
      requirementsFilePath: ".agent-workflow/external-requests/external-crm/20260825T00000000-requirements.md",
