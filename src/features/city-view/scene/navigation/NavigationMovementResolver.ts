...
import type { CityCollisionMap } from "../tilemap/CityCollisionMap";

export class NavigationMovementResolver {
  constructor(private readonly collisionMap: CityCollisionMap) {}
